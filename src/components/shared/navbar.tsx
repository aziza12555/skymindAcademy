    ...
    <div className="fixed top-0 left-0 right-0 bg-white border-b z-50">
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        <Link to="/" className="flex items-center space-x-2">
          <img className="w-9" src="https://i.pinimg.com/1200x/ab/01/89/ab01895078f02efdf95f7b486f94d7cd.jpg" alt="" />
        <h1>Zarxal</h1>
       ...
       <SearchBar/>
        ...
        <Heart/>
        <ShoppingBag/>
          <button className="bg-[#800020] text-white px-3 py-1 rounded font-semibold hover:bg-gray-800 transition">
          Hoziroq sotib oling
          </button>
          <Link
            to="/signup"
      ...
      <nav className="border-t border-gray-200">
        <div className="container mx-auto flex space-x-6 py-3 px-4 font-semibold text-md">
